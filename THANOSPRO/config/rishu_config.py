# IF YOU ARE HOSTING THANOSPRO ON OTHER VPS OR LOCALLY RATHER THAN HEROKU
...
class Config(object):
    ...
    MY_CHANNEL = os.environ.get("YOUR_CHANNEL", "thanospros")
    MY_GROUP = os.environ.get("YOUR_GROUP", "THANOSPRO_Chat")
    ...
    THANOSPRO_SESSION = os.environ.get("THANOSPRO_SESSION", None)
    ...
    THUMB_IMG = os.environ.get("THUMB_IMG", "./THANOSPRO/resources/pics/THANOSPRO_logo.jpg")
    UNLOAD = list(os.environ.get("UNLOAD", "").split())
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/thanosuser/THANOS-PROS")
