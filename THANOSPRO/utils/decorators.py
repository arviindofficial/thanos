...
from THANOSPRO.clients import H2, H3, H4, H5
...
def admin_cmd(pattern=None, command=None, **args):
    ...
    # blacklisted chats. 
    # THANOSPRO will not respond in these chats.
