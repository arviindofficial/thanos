...
from THANOSPRO.sql.waifu_sql import is_harem, add_grp, rm_grp, get_all_grp
from THANOSPRO.sql.husb_sql import is_husb, add_hus_grp, rm_hus_grp, get_all_hus_grp
from . import *
...
@rishu_cmd(pattern="pt(?:\s|$)([\s\S]*)")
async def _(event):
    BASE_URL = "http://images.google.com"
    if event.reply_to_msg_id:
        rishu = await eor(event, "Hmm..")
