...
@rishu_handler(func=lambda e: e.is_private)
async def monito_p_m_s(event):
    ...
    if not sender.bot:
        ...
        if lg_id is not None:
            if chat.id not in NO_PM_LOG_USERS and chat.id != ultronceo:
                try:
