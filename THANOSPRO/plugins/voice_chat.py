...
@rishu_cmd(pattern="vcinvite$")
async def _(event):
    rishu = await eor(event, "`🧐 Inviting Users To Voice Chat....`")
    users = []
    i = 0
    ...
    for k in hel_:
        try:
            ...
            pass
    await rishu.edit(f"**🚀 Invited {i} Users to Voice Chat**")
