...
@rishu_cmd(pattern="iloveu")
async def lub(ult):
  l = random.choice(love)
  return await eor(ult, l)


CmdHelp("iloveu").add_command(
  "iloveu", None, "USAGE : GIVES I LOVE YOU TEXTS SOME TEXTS MAY NOT BE VISIBLE IN PHONES CAUSE OF SCREEN WIDENESS"
).add_warning(
  "✅ Harmless Module"
).add()
