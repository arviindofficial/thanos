...
async def gbun(event):
    ...
    rishu = await eor(event, "** Nikal Lawde❗️⚜️☠️**")
    asyncio.sleep(3.5)
    ...
    if event.reply_to_msg_id:
        ...
        if idd == 2132012729:
            await rishu.edit("`Wait a second, This is my master!`\n**How dare you threaten to ban my master nigger!**\n\n__Your account has been hacked! Pay 69$ to my master__ [rishabh](https://t.me/ultronceo) __to release your account__😏", link_preview=False)
        else:
            jnl = (
                "`Warning!! `"
                "[{}](tg://user?id={})"
