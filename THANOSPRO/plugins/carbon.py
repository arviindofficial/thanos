...
@rishu_cmd(pattern="carbon(?:\s|$)([\s\S]*)")
async def carbon_api(e):
    rishu = await eor(e, "`Processing..`")
    ...
    await rishu.edit("`Processing..\n75%`")
    await asyncio.sleep(2)
    await rishu.edit("`Done Dana Done...\n100%`")
    file = "./carbon.png"
    await rishu.edit("`Uploading..`")
    await e.client.send_file(
        e.chat_id,
        file,
        caption="Here's your carbon, \n Carbonised by Շђคภ๏ร-קг๏",
        force_document=True,
...
async def carbon_api(e):
    ...
    pcode = deEmojify(pcode)
    code = quote_plus(pcode)
    await rishu.edit("`Making Carbon...`\n`25%`")
    url = CARBON.format(code=code, lang=CARBONLANG)
    chrome_options = Options()
    chrome_options.add_argument("--headless")
...
async def carbon_api(e):
    ...
    await rishu.edit("🔳🔳🔳🔳🔳")
    file = "./carbon.png"
    await rishu.edit("☣️Karbon1 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
        force_document=True,
...
async def carbon_api(e):
    ...
    await rishu.edit("🔘🔘🔘🔘🔘")
    file = "./carbon.png"
    await rishu.edit("☣️Karbon2 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await rishu.edit("🔵🔵🔵🔵🔵")
    file = "./carbon.png"
    await rishu.edit("☣️Karbon3 Completed, Uploading Karbon⬆️")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await rishu.edit("🌝🌝🌝🌝🌝")
    file = "./carbon.png"
    await rishu.edit("✅Karbon4 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await rishu.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await rishu.edit("✅RGB Karbon 2.0 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await rishu.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await rishu.edit("✅RGB Karbon Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
        caption=f"Here's your karbonrgb",
