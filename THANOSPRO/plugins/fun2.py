...
@rishu_cmd(pattern="cat$")
async def hmm(rishu):
    reactcat = nekos.textcat()
    await eor(rishu, reactcat)


@rishu_cmd(pattern="why$")
async def hmm(rishu):
    whyrishu = nekos.why()
    await eor(rishu, whyrishu)


@rishu_cmd(pattern="fact$")
async def hmm(rishu):
    factrishu = nekos.fact()
    await eor(rishu, factrishu)
